...
# '''
# def my_print(age):
#     print('이예진: '+ str(age) +'살입니다') #이름: 18살입니다.
#     print('이예진: ',age, '살입니다') #이름:  18 살입니다.
#     print(f'이예진: {age}살입니다.')
#
# print('-' * 20)
#
# def my_print2(name,age):
#     print(name+': '+ str(age) +'살입니다') #이름: 18살입니다.
...
# print(my_print2(age=20,name='안유진'))  #아규면트 순서와 관계없이 파라미터 이름을 쓰면 거기에 들어감
#
# print('-' * 20)
#
...
# my_print3('안유진', group='아이브', age = 20 )    #위치 인자는 무조건 인자 앞에 있어야 함
#
# print('-' * 20)
#
...
#     print(name,': ',age, '살입니다. ',group,'소속입니다.') #이름:  18 살입니다.
#     print(f'{name}: {age}살입니다.{group}소속입니다.')
# my_print4('안유진', age = 20, group='아이즈원' )
#
# print('-' * 20)
#
# #가변인자
...
# print('-' * 20)
# def say(name, msg='안녕하세요',feeling='ヾ(≧▽≦*)o'):
#     print(f'{name}, {msg} {feeling}')
# say('가현')
# say('가현',feeling='(✿◡‿◡)(´▽`ʃ♡ƪ)')
#
# print('-' * 20)
# def fn(a, b=[]):
#     b.append(a)
